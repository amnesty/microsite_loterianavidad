...
<aside class="cookie-consent__modal cookie-consent__modal--animate-translate-down js-cookie-consent__modal" id="cookie-consent__modal" data-omcookie-panel="1" data-track-content data-content-name="Aviso cookies">
    ...
    document.addEventListener('DOMContentLoaded', function(){
        ...
        if (openCookiePanel === true) {
            ...
            setTimeout(function () {
                ...
                ajaxCookieStatsSendRequest(cookieStatsUrls.show);
            },1000);
        } else {
...
// ** COOKIES BEHAVIOUR ** //
    ...
    var omCookieSaveAction = function() {
        ...
        document.dispatchEvent(new CustomEvent("trackPageWithCookieConsent"));
        //document.dispatchEvent(new CustomEvent("trackPage"));
    ...
    var ajaxCookieStatsResponse = [];
    var ajaxCookieStatsSendRequest = function(url) {
        ...
        xhr.onload = function (e) {
          if (xhr.readyState === 4) {
            if (xhr.status === 200) {
                ajaxCookieStatsResponse.push(xhr.response);
            } else {
