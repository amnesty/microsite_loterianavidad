...
<head>
    ...
    <meta name="description" content="Acabo de firmar para que Rosa cumpla su ilusión de conseguir justicia #PedimosJusticia">
    <link rel="canonical" href="<?php echo URL_SITE; ?>rosa-garcia" />
    <link rel="image_src" href="<?php echo URL_SITE; ?>images/new_social/compartir-tw-caso-rosa.png" />
    ...
    <meta property="og:description" content="Acabo de firmar para que Rosa cumpla su ilusión de conseguir justicia #PedimosJusticia" />
    <meta property="og:site_name" content="Seguimos pidiendo justicia" />
    <meta property="og:image" content="<?php echo URL_SITE; ?>images/new_social/compartir-fb-caso-rosa.png" />
    ...
    <meta name="twitter:image" content="<?php echo URL_SITE; ?>images/new_social/compartir-tw-caso-rosa.png" />
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                    ...
                    <div class="rrss">
                        <ul class="clearfix">
                            ...
                            <li><a data-e_c="justiciapornavidad" data-e_a="<?=$casos[$caso][2]?> comp TW" data-e_l="<?=$casos[$caso][2]?> comp TW" data-shareurl="<?php echo urlencode('http://amn.st/60051ZByt'); ?>" data-texto="Acabo de firmar para que Rosa cumpla su ilusión de conseguir justicia #PedimosJusticia" class="fa fa-twitter twitter-share send-piwik-event" title="Compartir en Twitter" href="#"></a></li>
<?php
if($isMobile) {
?>
                            <li><a data-e_c="justiciapornavidad" data-e_a="<?=$casos[$caso][2]?> comp WH" data-e_l="<?=$casos[$caso][2]?> comp WH" class="fa fa-whatsapp send-piwik-event" title="Compartir en Whatsapp" data-href="<?php echo URL_SITE; ?>rosa-garcia" data-action="share/whatsapp/share" href="whatsapp://send?text=<?=urlencode('Acabo de firmar para que Rosa cumpla su ilusión de conseguir justicia #PedimosJusticia http://amn.st/60031ZBJz')?>"></a></li>
<?php
}
?>
                        </ul>
