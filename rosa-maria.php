...
<head>
    ...
    <link rel="canonical" href="<?php echo URL_SITE; ?>rosa-maria" />
    ...
    <!--Open Graph-->
    <meta property="og:url" content="<?php echo URL_SITE; ?>rosa-maria" />
    ...
    <!--Twitter Cardas-->
    <meta name="twitter:url" content="<?php echo URL_SITE; ?>rosa-maria" />
...
<body>
	...
	<section class="modulo-interior clearfix">
		<div class="container">
            <h1>Rosa María, la historia de una mujer torturada.</h1>
			<div class="row">
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                    ...
                    <div class="rrss">
                        <ul class="clearfix">
                            <li><a data-shareurl="<?php echo URL_SITE . 'rosa-maria' . TRACK_FB_UTM ; ?>" class="fa fa-facebook facebook-share" href="#" title="Compartir en Facebook"></a></li>                            
                            <li><a data-shareurl="<?php echo urlencode('https://goo.gl/2ZtG4n'); ?>" data-texto="Firma y ayuda a Rosa María a hacer realidad un deseo que lleva muchos años sin cumplirse justicia" class="fa fa-twitter twitter-share" title="Compartir en Twitter" href="#"></a></li>
<?php
if($isMobile) {
?>
                            <li><a class="fa fa-whatsapp" title="Compartir en Whatsapp" data-href="<?php echo URL_SITE; ?>rosa-maria" data-action="share/whatsapp/share" href="whatsapp://send?text=<?=urlencode('Esta Navidad toca Justicia – Amnistía Internacional https://goo.gl/1FCsOG')?>"></a></li>
<?php
}
?>
                        </ul>
